...
* anchors attached to h2 id attributes. The h2 is the Feat Name.
  * directly following the Feat Name (the next sibling of the h2 tag) is the Feat Description. This is always true.
  * the next sibling of the Description is a p class="stat-block-1" regardless of whether it is a prereq, a benefit, a normal, or a special
 * recommended approach: get desired anchored h2 tag, then call next sibling and store the data until you hit another h2 tag.
...
-->
**Solved my issues:** if we get the href and the anchors, and we sort 
