    ...
    render(){
        return(
            <div className="flex-container col-xs-12 bordered">
                ...
                <div className="flex-container sm-wrap" style={{display: this.state.show? '': 'none'}}>
                    <div>
                    ...
                    <div>
                        <select className="form-control" aria-describedby="alignment" name="Alignment"
                    ...
                    <div>
                        <select aria-describedby="race" className="form-control"
